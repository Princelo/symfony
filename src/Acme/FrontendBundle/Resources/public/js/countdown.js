...
function(module) {
	...
	var resetLabels = countdown.resetLabels = function() {
        ...
        LABELS_SINGLUAR = 'millisecond|秒|分|小时|日|week|month|year|decade|century|millennium'.split('|');
		//LABELS_PLURAL = 'milliseconds|seconds|minutes|hours|days|weeks|months|years|decades|centuries|millennia'.split('|');
        LABELS_PLURAL = 'milliseconds|秒|分|小时|日|weeks|months|years|decades|centuries|millennia'.split('|');
		//LABEL_LAST = 'and ';
        LABEL_LAST = '';
		//LABEL_DELIM = ', ';
        LABEL_DELIM = ' ';
